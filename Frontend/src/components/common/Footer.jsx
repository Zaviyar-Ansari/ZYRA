    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-lg-md focus:outline-none focus:rin-2 focus:ring-gray-500 transition-all"
              required
            />
        ...
        <div>
          ...
          <FiPhoneCall className="inline-block mr-2">0123-456-789</FiPhoneCall>
        </div>
      </div>
      {/* footer bottom */}
      <div className="continer mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6 ">
        <p className="text-gray-500 text-sm tracking-tight text-center">
          2026, CompileTab. All Right Reserved
        </p>
      </div>
    </footer>
  );
